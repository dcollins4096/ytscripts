...
add_field('rel_kinetic_energy',function=_rel_kinetic_energy,units=eng_units,validators=[ValidateParameter('bulk_velocity')])
...
def _grav_pot(field,data):
    ...
    return output
add_field('grav_pot',function=_grav_pot,units=eng_units)
...
add_field('gas_work',function=_gas_work,units=eng_units)
