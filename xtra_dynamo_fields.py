...
add_field('Ltension_x', function=_Ltension_x,validators=std_validators, take_log=False, units = momentum_rate_units) 
...
add_field('Ltension_y', function=_Ltension_y,validators=std_validators, take_log=False, units = momentum_rate_units) 
...
add_field('Ltension_z', function=_Ltension_z,validators=std_validators, take_log=False, units = momentum_rate_units) 
def _Lpressure_x(field,data):
    return -1*grad(data,'magnetic_energy',0) #the 1/8pi is in the magnetic energy.
add_field('Lpressure_x', function=_Lpressure_x,validators=std_validators, take_log=False, units=momentum_rate_units)
def _Lpressure_y(field,data):
    return -1*grad(data,'magnetic_energy',1)
add_field('Lpressure_y', function=_Lpressure_y,validators=std_validators, take_log=False, units=momentum_rate_units)
def _Lpressure_z(field,data):
    return -1*grad(data,'magnetic_energy',2)
add_field('Lpressure_z', function=_Lpressure_z,validators=std_validators, take_log=False, units=momentum_rate_units)
...
add_field('Badvection_x',function=_Badvection_x, validators=std_validators, take_log=False, units=magnetic_rate_units)
def _Badvection_y(field,data):
    return -1*AdotDel(data, ['x-velocity','y-velocity','z-velocity'], 'By')
add_field('Badvection_y',function=_Badvection_y, validators=std_validators, take_log=False, units=magnetic_rate_units)
def _Badvection_z(field,data):
    return -1*AdotDel(data, ['x-velocity','y-velocity','z-velocity'], 'Bz')
add_field('Badvection_z',function=_Badvection_z, validators=std_validators, take_log=False, units=magnetic_rate_units)
...
add_field('Bcompression_x',function=_Bcompression_x, validators=std_validators, take_log=False, units=magnetic_rate_units)
def _Bcompression_y(field,data):
    div_v = grad(data,'x-velocity',0)+grad(data,'y-velocity',1)+grad(data,'z-velocity',2)
    return -1*data['By']*div_v
add_field('Bcompression_y',function=_Bcompression_y, validators=std_validators, take_log=False, units=magnetic_rate_units)
def _Bcompression_z(field,data):
    div_v = grad(data,'x-velocity',0)+grad(data,'y-velocity',1)+grad(data,'z-velocity',2)
    return -1*data['Bz']*div_v
add_field('Bcompression_z',function=_Bcompression_z, validators=std_validators, take_log=False, units=magnetic_rate_units)

def _Bstretching_x(field,data):
    return AdotDel(data,['Bx','By','Bz'], 'x-velocity')
add_field('Bstretching_x',function=_Bstretching_x, validators=std_validators,take_log=False, units=magnetic_rate_units)
def _Bstretching_y(field,data):
    return AdotDel(data,['Bx','By','Bz'], 'y-velocity')
add_field('Bstretching_y',function=_Bstretching_y, validators=std_validators,take_log=False, units=magnetic_rate_units)
def _Bstretching_z(field,data):
    return AdotDel(data,['Bx','By','Bz'], 'z-velocity')
add_field('Bstretching_z',function=_Bstretching_z, validators=std_validators,take_log=False, units=magnetic_rate_units)
...
add_field('Normalized_LP',function=_normalized_LP, validators=std_validators,take_log=False, units='1/s')
...
add_field('Normalized_LT',function=_normalized_LT, validators=std_validators,take_log=False, units='1/s')
...
add_field('Normalized_BA',function=_normalized_BA, validators=std_validators,take_log=False,units='1/s')
...
add_field('Normalized_BC',function=_normalized_BC, validators=std_validators,take_log=False,units='1/s')
...
add_field('Normalized_BS',function=_normalized_BS, validators=std_validators,take_log=False,units='1/s')
...
def generate_normed_unit(quantity,magnitude,units):
    ...
    add_field(field_name, function = _temp, units=units, take_log=False)
...
def generate_full2(field_name, force_name): 
    ...
    add_field(new_field_name, function = _temp, units = 'code_magnetic**2/s')
