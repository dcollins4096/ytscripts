...
def add_unweighted_stokes(axis):
    ...
    yt.add_field('unweighted_Q%s'%axis, units='dimensionless', function=_unweighted_Q_local)
    ...
    yt.add_field('unweighted_U%s'%axis, units='dimensionless', function=_unweighted_U_local)
...
def add_N2(axis, n0, p):
    ...
    yt.add_field('N2%s_n0-%04d_p-%d'%(axis,n0,p), units='dimensionless', function=_N2_local)    
