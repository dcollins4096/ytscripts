...
#c_unit = a_unit cross b_unit
    ...
    def right_roe_balsara(self,d,vx,vy,vz,hx,hy,hz,eng, EquationOfState = 0, Gamma=5./3, IsothermalSoundSpeed=1):
        ...
        left['f-']['vx']  = -1.*alph_f*cf*over_two_a2
        
        right['f-']['vy'] = +1.*alph_s*betay*cs*sbx#+ alph_f*vy  #may be
        left['f-']['vy']  = +1.*alph_s*cs*betay*sbx*over_two_a2
        
        right['f-']['vz'] = +1.*alph_s*betaz*cs*sbx#+ alph_f*vz  #incorrect. 
        left['f-']['vz']  = +1.*alph_s*cs*betaz*sbx*over_two_a2
        ...
        left['f+']['by'] =  alph_s*aa*betay*sqrtDi*over_two_a2
        left['f+']['bz'] =  alph_s*aa*betaz*sqrtDi*over_two_a2
        left['f+']['p']  =  alph_f/d
        ...
        left['s+']['by'] = -alph_f*aa*betay*sqrtDi*over_two_a2
        left['s+']['bz'] = -alph_f*aa*betaz*sqrtDi*over_two_a2
        left['s+']['p']  =  alph_s/d
