...
if 'prof_mag' not in dir():
    prof_mag  = yt.create_profile(region, bin_fields=bin_fields[0:1],fields=['cell_volume'], weight_field=None, override_bins=bins)
if 'prof_theta' not in dir():
    prof_theta  = yt.create_profile(region, bin_fields=bin_fields[1:],fields=['cell_volume'], weight_field=None, override_bins=bins)
