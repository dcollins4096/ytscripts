...
PAk2d = np.sqrt(2*np.pi/Deltak* PAk)  #make this 2d, with the right symmetry; 2pi/Deltak needs (2pi)^2/(dki dkj)
Aharm = uharm * PAk2d # Compute the harmonics of the Gaussianized field
