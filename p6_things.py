...
car.frames=range(0,200,20)
car.Colorbar='fixed'
car.extrema['density']=[1e-25,1e-22]
car.extrema['pressure']=[1e-13,1e-12]
car.phase(['density','pressure','cell_mass'],phase_callbacks=[equillibrium_callback])
if 0:
    car = fa02
